...
export default function MovieDetails ({movieObj, onClose}) {
  ...
  useEffect(() => {
    async function getMovieDetails() {
      ...
      setLoading(true);
      try {
        const response = await fetch(`https://api.themoviedb.org/3/movie/${movieObj.id}?language=${language}&page=${page}&append_to_response=credits`, 
          {
            headers: {
        ...
        <div className="card-body">
          <div className="row">
            <div className="col-md-3">
              <img src={"https://image.tmdb.org/t/p/original/" + movieObj.poster_path} className="img-fluid"/>
            </div>
